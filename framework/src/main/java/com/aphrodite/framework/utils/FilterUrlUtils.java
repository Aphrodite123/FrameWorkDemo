...
/**
 * Created by Aphrodite on 2018/4/8.
 * 用于过滤WebView的URL
 */
public class FilterUrlUtils {
    ...
    public FilterUrlUtils(Activity activity) {
        this.mActivity = activity;
    }

    public boolean shouldOverrideUrlLoadingByApp(WebView view, String url) throws URISyntaxException {
    ...
    private boolean tryHandleByMarket(Intent intent) throws ActivityNotFoundException {
